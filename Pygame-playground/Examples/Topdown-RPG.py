...
while running:
    ...
    player_pos[0] = max(0, min(player_pos[0], SCREEN_WIDTH - TILE_SIZE))
    player_pos[1] = max(0, min(player_pos[1], SCREEN_HEIGHT - TILE_SIZE))

    # Fill the screen with white
    screen.fill(WHITE)

    # Draw the player
    pygame.draw.rect(screen, GREEN, (player_pos[0], player_pos[1], TILE_SIZE, TILE_SIZE))
